            ...
            <div class="container-fluid">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                    ...
                                                                    <textarea class="form-control" disabled name="comen_syllabu" id="comen_syllabu" cols="30" rows="20">
                                                                            <?php
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                    ...
                                                                    <textarea class="form-control" name="comen_compt_asoci_curso" id="comen_compt_asoci_curso" cols="30" rows="5">
                                                                            <?php
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                    ...
                                                                    <textarea class="form-control" name="comen_result_general_apren" id="comen_result_general_apren" cols="30" rows="20">
                                                                            <?php
                ...
                <script>
                    ...
                    $(document).ready(function() {
                                ...
                                $('#comen_syllabu').summernote('disable');  

                                $('#comen_compt_asoci_curso').summernote('disable');  

                                
                         
                                $('#comen_sumilla').summernote('disable');  
                                $('#comen_result_general_apren').summernote('disable');  
                                $('#comen_org_aprendizaje').summernote('disable');  


                                $('#comen_desc_estrateg_didact').summernote('disable');  

                                
                                $('#comen_forma_herrami_eval').summernote('disable');  

                            


                                $('#comen_actividades_pricipales').summernote('disable');  
                                $('#comen_plataformas_herramientas').summernote('disable');  

                                
                                $('#comen_tipo_bibliografia').summernote('disable');  
