            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">¡Bienvenido <?php echo actualizar_data_logeo($_SESSION['usuario'][0]['id_usuario'],'usuario_nombres'); ?>  <?php echo actualizar_data_logeo($_SESSION['usuario'][0]['id_usuario'],'usuario_apater'); ?>!</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <!-- <li class="breadcrumb-item"><a href="">Carrera de <?php echo actualizar_data_logeo($_SESSION['usuario'][0]['id_usuario'],'nom_carrera'); ?></a></li> -->
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<!--                      
                ...
                <?php  if($_SESSION['usuario'][0]['id_nivel'] != 3){ ?>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Gráfico estadístico de los estados de los Planes de Estudios </h4>
                                <div id="plan_estudios_grafica" class="mt-2" style="height:283px; width:100%;"></div>
                                <ul class="list-style-none mb-0" id="plan_estudios_grafica_box">
                                    <li>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Gráfico estadístico de los estados de los Sillabus</h4>
                                <div id="syllabus_grafica" class="mt-2" style="height:283px; width:100%;"></div>
                                <ul class="list-style-none mb-0" id="syllabus_grafica_box">
                                    <li>
                                        <i class="fas fa-circle text-primary font-10 mr-2"></i>
                ...
                <?php  if($_SESSION['usuario'][0]['id_nivel'] == 3){ ?>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Estadistica de los estados de los Sillabus</h4>
                                <div id="syllabus_grafica" class="mt-2" style="height:283px; width:100%;"></div>
                                <ul class="list-style-none mb-0" id="syllabus_grafica_box">
                                    <li>
                                        <i class="fas fa-circle text-primary font-10 mr-2"></i>
                ...
                <?php } ?>
                    ...
                    <!-- <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Fichas de Evaluación</h4>
                                <div id="fichas_eval_grafica" class="mt-2" style="height:283px; width:100%;"></div>
