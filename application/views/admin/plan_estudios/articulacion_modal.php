<!-- <div class="modal-body" > -->
    ...
    <div class="col-md-12 row" style="padding: 0px;margin: 0px;">
        <div class="form-group col-md-12" style="padding: 0px;margin: 0px;" id="vista_articula">
          
            <!-- <div class="table-responsive">
                <table id="tabla_articulacion" class="table table-hover table-info">
                    <thead class="bg-info text-white">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="text-center" style="background: cyan; border-bottom: 1px solid black; border-left: 1px solid black; border-top: 1px solid black; ">Competencia nombre</th>
                            <th scope="col" class="text-center" style="background: cyan; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black;">Nivel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                            <th scope="col" class="text-center"  style="background: cyan; border-bottom: 1px solid black; border-left: 2px solid black; border-top: 1px solid black; ">Competencia nombre</th>
                            <th scope="col" class="text-center" style="background: cyan; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black;">Nivel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
