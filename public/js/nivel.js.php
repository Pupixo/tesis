<script>
    ...
    function cargarTabla<?php echo $opcion; ?>(){
        ...
        processing ? loading_tabla(true) : loading_tabla(false);
            ...
            "responsive": true,
            "columns": [
                {"data": "ID_NIVEL" , "className": "never", "autoWidth": true, "orderable": false, "visible": false},
                {"data": "NOM_NIVEL"},
                {"data": "NOM_ESTATUS" },
    ...
    function fn_limpiarPopup(){
        ...
        $(objGeneral.modal_principal+" "+'#nom_nivel').val('');
    ...
    function fn_AbrirModal(Accion,id_row,fila,funcion_name){
        ...
        if( Accion === 'I'){
            ...
            $(objGeneral.modal_principal+" "+"#titulo_modal_peque").text('Registrar '+objGeneral._nombre);
                ...
                /* Poner data en modal */
                $(objGeneral.modal_principal+" "+"#titulo_modal_peque").text('Actualizar '+objGeneral._nombre +' ' +data['NOM_NIVEL']);
                /*id para actualizar */
                $(objGeneral.modal_principal+" "+'#id_'+objGeneral._abrev).val(id_row);               
                //---

                $(objGeneral.modal_principal+" "+'#nom_nivel').val(data['NOM_NIVEL']);
    ...
    function Valida_<?php echo $opcion; ?>() {
        ...
        if($(objGeneral.modal_principal+" "+'#nom_nivel').val().trim() === '') {
            msgDate = 'Debe ingresar un nombre';
            inputFocus = '#nom_nivel';
            return false;
        }
