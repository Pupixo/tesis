<script>
    ...
    function cargarTabla<?php echo $opcion; ?>(){
        ...
        processing ? loading_tabla(true) : loading_tabla(false);
            ...
            "columns": [
                ...
                {"data": "ID_DEPART_UNI" , "className": "never", "autoWidth": true, "orderable": false, "visible": false },
                {"data": "NOM_ESTATUS" },
    ...
    function fn_limpiarPopup(){
        ...
        $(objGeneral.modal_principal+" "+'#nom_director').val('');
    ...
    function fn_AbrirModal(Accion,id_row,fila,funcion_name){
        ...
        if( Accion === 'I'){
            ...
            $(objGeneral.modal_principal+" "+"#titulo_modal_peque").text('Registrar '+objGeneral._nombre);
                ...
                /* Poner data en modal */
                $(objGeneral.modal_principal+" "+"#titulo_modal_peque").text('Actualizar '+objGeneral._nombre +' ' +data['NOM_DIRECTOR']);
                /*id para actualizar */
                $(objGeneral.modal_principal+" "+'#id_'+objGeneral._abrev).val(id_row);               
                //---

                $(objGeneral.modal_principal+" "+'#nom_director').val(data['NOM_DIRECTOR']);
    ...
    function Valida_<?php echo $opcion; ?>() {
        ...
        if($(objGeneral.modal_principal+" "+'#nom_director').val().trim() === '') {
            msgDate = 'Debe ingresar un nombre';
            inputFocus = '#nom_director';
            return false;
        }
